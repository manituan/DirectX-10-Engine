...
bool LightShaderClass::Initialize(ID3D10Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, L"../Manituan/light.fx");
	if(!result)
	{
		return false;
	}
...
void LightShaderClass::Render(ID3D10Device* device, int indexCount, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix, 
							  D3DXMATRIX projectionMatrix, ID3D10ShaderResourceView* texture, D3DXVECTOR3 cameraPosition, 
							  ...
							  D3DXVECTOR4 specularColor, float specularPower)
{
	...
	SetShaderParameters(worldMatrix, viewMatrix, projectionMatrix, texture, cameraPosition, lightDirection, 
...
void LightShaderClass::SetShaderParameters(D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix, D3DXMATRIX projectionMatrix,
										   ID3D10ShaderResourceView* texture, D3DXVECTOR3 cameraPosition, D3DXVECTOR3 lightDirection, 
										   D3DXVECTOR4 ambientColor, D3DXVECTOR4 diffuseColor, D3DXVECTOR4 specularColor, 
										   float specularPower)
{
