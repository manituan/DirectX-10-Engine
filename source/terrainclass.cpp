...
bool TerrainClass::Initialize(ID3D10Device* device, char* heightMapFilename, WCHAR* textureFilename, char* colorMapFilename)
{
	bool result;
	...
	// Initialize the vertex array that holds the geometry for the terrain.
