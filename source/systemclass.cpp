...
bool SystemClass::Initialize()
{
	...
	m_Position->SetPosition(50.0f, 3.0f, -10.0f);
...
bool SystemClass::HandleMovementInput(float frameTime)
{
	bool keyDown, result;
	...
	////LeftClick
	//MouseDown=m_Input->IsLeftMousePressed();
	//m_Position->LookDownward(MouseDown);
	...
	result = m_Graphics->SetCameraPosition(posX, posY, posZ, rotX, rotY, rotZ);
	if(!result)
	{
		return false;
	}
